...
function css() {
  return `<style id="pr3nt-final-portal-css">
    ...
    @media(max-width:600px){html,body{overflow-x:hidden!important}.portal-shell,.portal-main,main{padding-left:12px!important;padding-right:12px!important}.portal-nav{padding:10px!important;gap:8px!important}.portal-nav .nav-link:not(.account-icon),.portal-nav .nav-pill{flex:1 1 calc(50% - 8px)!important;height:42px!important;padding:0 10px!important;font-size:13px!important}.portal-nav .project-switcher{height:auto!important;min-height:46px!important;border-radius:18px!important;padding:8px 12px!important;display:grid!important;grid-template-columns:1fr!important;gap:4px!important}.portal-nav .project-switcher select{width:100%!important;height:34px!important;line-height:34px!important;font-size:14px!important}.status-hero{margin-top:8px!important;padding:22px 16px 18px!important;border-radius:22px!important}.status-hero h1{font-size:32px!important;line-height:1!important;margin-bottom:12px!important}.status-hero p{font-size:14px!important;line-height:1.5!important}.status-hero .next-action{min-height:0!important;padding:18px!important;border-radius:20px!important}.status-inner-card{align-items:flex-start!important}.mini-printer{width:70px!important;height:50px!important;flex-basis:70px!important}.project-info-grid,.preview-messages-grid,.self-grid.pr3nt-managed-selfservice{display:grid!important;grid-template-columns:1fr!important;gap:14px!important;margin-top:14px!important}.project-info-grid .card,.preview-messages-grid .card,.self-card,.price-card{border-radius:20px!important;padding:16px!important;min-height:0!important;box-shadow:0 10px 30px rgba(16,24,32,.06)!important}.project-info-grid .card h2,.preview-messages-grid .card h2{font-size:23px!important;margin-bottom:12px!important}.project-info-grid table,.project-info-grid tbody,.project-info-grid tr,.project-info-grid td{display:block!important;width:100%!important}.project-info-grid tr{padding:10px 0!important;border-bottom:1px solid var(--pr3nt-line)!important}.project-info-grid td{padding:0!important;border:0!important}.project-info-grid td:first-child{width:100%!important;font-size:12px!important;text-transform:uppercase!important;letter-spacing:.08em!important;margin-bottom:3px!important}.price-card h2{font-size:32px!important}.btn,button,.btn-light,.btn-primary,label.btn{width:100%!important;min-height:44px!important}.preview-messages-grid canvas,.preview-messages-grid model-viewer,.preview-messages-grid .viewer,.preview-messages-grid .model-viewer,#viewer{width:100%!important;max-width:100%!important;min-height:280px!important;max-height:360px!important;border-radius:18px!important}.pr3nt-file-carousel{gap:8px!important;padding-bottom:6px!important}.pr3nt-file-tile{flex-basis:72px!important;height:72px!important;border-radius:16px!important;padding:6px!important}.self-form textarea{min-height:82px!important}.modal-card{width:calc(100vw - 24px)!important;max-width:calc(100vw - 24px)!important;border-radius:22px!important;padding:18px!important}.action-row{display:grid!important;grid-template-columns:1fr!important;gap:10px!important}}
  </style>`;
}
