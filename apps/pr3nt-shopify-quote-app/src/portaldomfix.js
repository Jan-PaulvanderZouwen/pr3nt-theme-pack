...
function css() {
  return `<style id="pr3nt-final-portal-css">
    :root{--pr3nt-ink:#101820;--pr3nt-muted:#667085;--pr3nt-line:#e5e7eb;--pr3nt-soft:#f6f8f7;--pr3nt-green:#00d084;--pr3nt-radius:24px;--pr3nt-shadow:0 18px 60px rgba(16,24,32,.08)}
    ...
    .portal-nav{display:flex!important;align-items:center!important;min-height:68px!important;padding:10px 14px!important;border-radius:28px!important;box-shadow:0 14px 44px rgba(16,24,32,.07)!important}.project-switcher,.nav-pill{order:50!important}.account-icon{font-size:0!important;width:44px!important;height:44px!important;padding:0!important;display:inline-grid!important;place-items:center!important;order:9999!important;margin-left:auto!important;background:#eef3f2!important;color:var(--pr3nt-ink)!important}.account-icon::after{content:'👤';font-size:20px}
    .portal-nav .nav-link,.portal-nav .nav-pill,.project-switcher{height:44px!important;border-radius:999px!important;font-size:14px!important;font-weight:850!important;letter-spacing:-.02em!important}
    ...
    .grid.one-card{grid-template-columns:1fr!important}.project-info-grid,.self-grid.pr3nt-managed-selfservice{grid-column:1 / -1!important;width:100%!important;max-width:none!important}.project-info-grid{display:grid!important;grid-template-columns:minmax(0,1.18fr) minmax(340px,.82fr)!important;gap:20px!important;align-items:stretch!important;margin:28px 0 0!important}.project-info-grid .card,.self-card,.price-card,.preview-messages-grid .card{border-radius:26px!important;border:1px solid var(--pr3nt-line)!important;box-shadow:0 18px 56px rgba(16,24,32,.07)!important;background:#fff!important}.project-info-grid .card{margin:0!important;min-height:0!important;height:100%!important;display:flex!important;flex-direction:column!important;padding:24px!important}.project-info-grid .card h2,.preview-messages-grid .card h2{font-size:28px!important;line-height:1.08!important;letter-spacing:-.055em!important;margin:0 0 18px!important}
    ...
    .preview-messages-grid{grid-column:1 / -1!important;width:100%!important;display:grid!important;grid-template-columns:minmax(0,1.18fr) minmax(340px,.82fr)!important;gap:20px!important;align-items:stretch!important;margin:28px 0 0!important}.preview-messages-grid .card{padding:24px!important;height:100%!important}.preview-messages-grid canvas,.preview-messages-grid model-viewer,.preview-messages-grid .viewer,.preview-messages-grid .model-viewer{border-radius:22px!important;background:#f7f8f8!important}.preview-messages-grid .model-card,.preview-messages-grid .preview-card{min-height:420px!important}
    ...
    @media(max-width:850px){.portal-nav{border-radius:22px!important}.status-hero{padding:26px 20px 22px!important;border-radius:26px!important}.status-hero h1{font-size:40px!important}.self-grid.pr3nt-managed-selfservice,.project-info-grid,.preview-messages-grid{grid-template-columns:1fr!important}.project-info-grid .card,.self-card,.preview-messages-grid .card{padding:20px!important}.account-icon{margin-left:0!important}.status-info-toggle{right:14px!important;top:14px!important}.status-popover{right:0!important;left:auto!important;width:min(320px,calc(100vw - 32px))!important}}
  </style>`;
}
